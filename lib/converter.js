 ...
 */
export async function convert({ inputPath, outputWidth = 100, color = false, onFrame, startTime, endTime, meta, collectFrames = true, targetFps, tone, charMode = 'ascii', foreground = null, crop = null, signal = null }) {
	...
	const asciiHeight = Math.max(1, Math.round(outputWidth * (srcH / srcW) * (CELL_W / CELL_H)));
