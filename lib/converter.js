 ...
 */
export async function convert({ inputPath, outputWidth = 100, color = false, onFrame, startTime, endTime, meta, collectFrames = true, targetFps, tone, charMode = 'ascii', foreground = null, signal = null }) {
