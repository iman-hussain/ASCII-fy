...
async function initFFmpeg() {
	...
	if (typeof SharedArrayBuffer === 'undefined') {
		console.warn("SharedArrayBuffer is not available. ffmpeg.wasm might fall back to single-threaded mode or fail. Ensure COOP/COEP headers are set.");
	}
	...
	try {
		...
		try {
			...
			throw new Error('Failed to load FFmpeg from both CDN sources. Please check your internet connection.');
		}
	}
	return ffmpeg;
}
