...
async function initFFmpeg() {
	...
	const v = '0.12.6';
	const cdns = [
		{ name: 'unpkg.com',       core: `https://unpkg.com/@ffmpeg/core@${v}/dist/umd/ffmpeg-core.js`,            wasm: `https://unpkg.com/@ffmpeg/core@${v}/dist/umd/ffmpeg-core.wasm` },
		{ name: 'jsdelivr.net',    core: `https://cdn.jsdelivr.net/npm/@ffmpeg/core@${v}/dist/umd/ffmpeg-core.js`, wasm: `https://cdn.jsdelivr.net/npm/@ffmpeg/core@${v}/dist/umd/ffmpeg-core.wasm` },
	];

	console.log('[ASCII-fy] Loading FFmpeg WASM core (~30 MB)...');

	const LOAD_TIMEOUT = 45000; // 45s per CDN attempt
	...
	for (let i = 0; i < cdns.length; i++) {
		...
		try {
			await withTimeout(
				ff.load({ coreURL: cdn.core, wasmURL: cdn.wasm }),
				LOAD_TIMEOUT,
				cdn.name
			);
