...
// For truecolor qStep=24, minimum single-channel distance² = 576, so
// this threshold smooths sub-step flicker between close quantised bins.
const COLOUR_DELTA_THRESHOLD = 600;
...
export async function generateBundle({ frames, width, height, fps, color, outputDir, render }) {
	...
	const qStep = palette ? 1 : 24;  // 24 for truecolor — fewer unique colours, better compression
